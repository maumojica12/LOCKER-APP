...
public class AppFX extends Application {
    ...
    private static void handleManageUsers(Stage stage) {
        ...
        VBox leftMenu = userMenuButton(menuLabels, 0, 3, stage);
        VBox rightMenu = userMenuButton(menuLabels, 3, 6, stage);
        StackPane root = new StackPane();
        root.getChildren().addAll(backgroundView, leftMenu, rightMenu);
        StackPane.setAlignment(leftMenu, Pos.CENTER_LEFT);
        StackPane.setAlignment(rightMenu, Pos.CENTER_RIGHT);
    ...
    private static void registerUser(Stage stage) {
        ...
        registerBtn.setOnAction(e -> {
            ...
            if (generatedId > 0) {
                ...
                successMessageLabel.setStyle("-fx-text-fill:yellow; -fx-font-size: 16px; -fx-font-weight: bold;");
    ...
    private static void handleManageLocations(Stage stage) {
        ...
        VBox leftMenu = locationMenuButton(menuLabels, 0, 2, stage);
        VBox rightMenu = locationMenuButton(menuLabels, 2, 4, stage);
                    ...
                    if (availableLockers.isEmpty()) {
                        ...
                        for (Locker locker : availableLockers) {
                           ...
                           checkBtn.setOnAction(ev -> {
                                ...
                                LocalDateTime selectedDate = selectedReservationDT[0];
                                double fee = 0;
    ...
    private static void cancelAReservation(Stage stage) {
     ...
     private static void handlePayments(Stage stage) {
        ...
        VBox leftMenu = paymentMenuButton(menuLabels, 0, 2, stage);
        VBox rightMenu = paymentMenuButton(menuLabels, 2, 4, stage);
            ...
            for (Booking booking : checkedInBookings) {
                ...
                processBtn.setOnAction(e -> {
                    ...
                    for (LockerSegment segment : segments) {
                        ...
                        double segmentTotal = usageFee + segment.getAdjustmentAmount();
    ...
    private static void performLockerTransfer(Stage stage) {
        ...
        bookingField.textProperty().addListener((obs, oldVal, newVal) -> {
            ...
            available.removeIf(l -> 
                l.getLockerID() == currentLockerID ||
                l.getLockerTypeID() == oldLocker.getLockerTypeID() ||
                l.getLocationID() != oldLocker.getLocationID() ||
                LockerTransferDAO.isLockerCurrentlyAssigned(l.getLockerID())
            );
...
private static void occReportLocation(Stage stage) {
    ...
    private static void canceledBookingsReport(Stage stage) {
            ...
            TableCell<CanceledBookingsReport, String> cell = new TableCell<>() {
                ...
                protected void updateItem(String item, boolean empty) {
                    ...
                    if (empty || item == null) {
                        ...
                        text.setText(item);
                        text.wrappingWidthProperty().bind(colReason.widthProperty().subtract(10));
                        setGraphic(text);
                    }
                }
            };
        ...
        layout.setPadding(new Insets(220, 20, 40, 20));
